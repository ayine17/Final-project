            ...
            try:
                ...
                # case of double down without enough chips
                    ...
                    if self.chips < hand.bet:
                        inputmsg = 'Not enough chips to double. Choose again: '
                        move = int(raw_input(inputmsg))
                    else:
                        self.chips -= hand.bet
                        break
                ...
                # case of split without enough chips
                    ...
                    if self.chips < hand.bet:
                        invalidmsg = 'Not enough chips to split. Choose again: '
                        move = int(raw_input(invalidmsg))
                    else:
                        self.chips -= hand.bet
                        break
...
class MainGame(object):
    """
    Implement a blackjack MainGame
    """
        ...
        while True:
            ...
            if self.dealer.valid_moves == 'Blackjack':
                ...
                for player, hands in self.positions:
                    ...
                    if hands[0].valid_moves == 'Blackjack':
                        ...
                        msg = '{} pushes on dealer blackjack.'
                        print msg.format(str(player))
                        print '\n'
                continue
                ...
                for hand in hands:
                    ...
                    while True:
                        ...
                        if hand.valid_moves == 'Blackjack':
                            sting = '{}  blackjack and wins {} chips!'
                            print sting.format(str(player), str(2 * hand.bet))
                            print '\n'
                        ...
                        if selected_move == 'Stay':
                            if len(hand.values) == 2:
                                ...
                                print msg. format(str(player), str(hand.values[1]))
                                print '\n'
                            else:
                                msg = '{} stays on {} '
                                
                                print msg .format(str(player), str(hand.values[0]))
                                print '\n'
                            staying_hands.append([player, hand])
                            break
                        ...
                        if selected_move == 'Double':
                            ...
                            if hand.valid_moves == 'Bust':
                                ...
                                break
                            msg = '{} ends  round with  {}'
                            print msg.format(str(player), str(max(hand.values)))
                            print '\n'
                            staying_hands.append([player, hand])
                            break

                        # for splits, make two new Hands and insert them after
                        # the current hand
                        if selected_move == 'Split':
                            msg = '{} splits hand in two {} '
                            print msg.format(player, str(hand.cards[0].rank))
                            print '\n'
            ...
            for player, hand in staying_hands:
                ...
                # loss
                    ...
                    msg = '{} loses with hand: {}'
                    print msg.format(str(player), str(hand))
            print '\nEnd of round.\n\n'
